    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-12 " >
                    <br><br>
                    <h2 align="center">DATA PEGAWAI PER DIVISI</h2>
                    <br><br>
                    <a href="tampil.php" class="btn btn-primary pull-left" > Kembali ke Awal</a>
                ...
                <table id="example1" class="table table-bordered table-striped test">
                    <div class="form-group" method="GET">
                                <label>Divisi</label>
                                <select name="id_divisi" id="select" class="form-control" placeholder="Pilih divisi"">
                    ...
                    <tbody>
                       <?php 
                            ...
                            $proses=$mysqli->query("SELECT pegawai.id_pegawai, pegawai.nama, pegawai.jenis_kelamin, divisi.nama_divisi, pegawai.alamat, pegawai.kontak FROM pegawai, divisi WHERE pegawai.id_divisi=id.divisi ORDER BY id_pegawai ASC");
                            $no=1;
